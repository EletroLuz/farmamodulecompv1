...
function countdown_display.update_and_draw()
    ...
    if screen_pos then
        local text_pos = vec2.new(screen_pos.x, screen_pos.y - 200)  -- 100 pixels acima do jogador
        
        graphics.text_2d("Teleporte em:", text_pos, 30, color_white)
        
        text_pos.y = text_pos.y + 60 -- era 40
